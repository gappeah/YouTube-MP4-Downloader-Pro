...
# Function to merge video and audio using ffmpeg (without re-encoding)
...
try:
    ...
    if download_quality == 'audio':
        ...
        if stream_prog:
            ...
            # Merge video and audio using ffmpeg (fast merging without re-encoding)
            print("Merging video and audio files using ffmpeg...")
